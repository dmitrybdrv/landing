...
/**
 * UnsubscribePage - компонент описывающий страницу отписки от получения письма
 */
        ...
        <div className={styles.blackListContainer}>
            ...
            <div className={styles.blackListMain}>
                <p>
                    ...
                    дальнейшие письма от сайта GilletteOpt.ru. Если вы хотите прекратить получение рассылок от нашего сайта, вы
                    можете нажать на кнопку "Не получать больше писем!" на этой странице. После этого мы больше не будем
                    отправлять вам письма с нашего сайта. Если вы ошибочно попали на эту страницу и не хотите отписываться от
                    рассылок, вы можете просто закрыть эту страницу или вернуться на сайт gilletteopt.ru.
                </p>
